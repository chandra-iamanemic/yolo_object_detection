...
def detect_common_objects(image, confidence=0.5, nms_thresh=0.05, model='yolov3-tiny'):
    ...
    if model == 'yolov2-tiny':
        ...
        weights_url = 'https://drive.google.com/uc?export=download&id=1BwV7rE0ejqYKJdUvj5KO7hOL-oENpv0l'
        ...
        weights_file_name = 'yolov3-tiny.weights'
        weights_url = 'https://drive.google.com/uc?export=download&id=1pwXyTHf2UJgiQPoQF6D7IEhWCRQtUUOh'
        blob = cv2.dnn.blobFromImage(image, scale, (416,416), (0,0,0), True, crop=False)    
