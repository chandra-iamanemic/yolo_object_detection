...
def populate_class_labels():
    ...
    url = 'https://raw.githubusercontent.com/chandra-iamanemic/yolo_object_detection/master/yolov3.txt'
...
def detect_common_objects(image, confidence=0.5, nms_thresh=0.3,download_fresh=0, model='yolov3-tiny'):
    ...
    if model == 'yolov2-tiny':
        ...
        cfg_url = "https://raw.githubusercontent.com/chandra-iamanemic/yolo_object_detection/master/yolov2-tiny-hands.cfg"
        weights_file_name = 'yolov3-tiny.weights'
        weights_url = 'https://drive.google.com/uc?export=download&id=1MnmrSRE8QqhV9rNrByghoJclR3A82z0q'
        blob = cv2.dnn.blobFromImage(image, scale, (416,416), (0,0,0), True, crop=False)


    else:
        config_file_name = 'yolov3-tiny.cfg'
        cfg_url = 'https://raw.githubusercontent.com/chandra-iamanemic/yolo_object_detection/master/yolov3-hands.cfg'
        
        weights_file_name = 'yolov3-tiny.weights'
        weights_url = 'https://drive.google.com/uc?export=download&id=15Fud-Q2_naWzKEPoNemIjLvTvDni09Nk'
        blob = cv2.dnn.blobFromImage(image, scale, (416,416), (0,0,0), True, crop=False)    
    ...
    if(download_fresh==1):
        print("Downloading Yolo Config File from Chandra's Github")
        wget.download(cfg_url, config_file_abs_path)
        print("Downloading Pre-Trained Weights from Chandra's Drive")
